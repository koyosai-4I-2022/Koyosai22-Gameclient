...
Shader "Shield-wall"
{
	...
	SubShader
	{
		...
		{
			o.Albedo = mul(tex2D(_Shield_Emission, i.uv_Shield_Emission).rgb, _Wire_Color);
			o.Albedo = mad(1, o.Albedo, tex2D(_Normal, i.uv_Normal).rgb);
